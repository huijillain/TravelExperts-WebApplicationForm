...
namespace TravelExperts
{
    public partial class AddEditPackage : Form
    {
        ...
        private ManagePackagesListing _managePackagesListing;
        private bool isEditMode;

        public AddEditPackage(ManagePackagesListing managePackagesListing = null)
        {
            InitializeComponent();
            lblTitle.Text = "Add New Package";
            this.Text = "Add New Package";
            isEditMode = false;
            _managePackagesListing = managePackagesListing;
            _db = new TravelExpertsEntities();
        }
        public AddEditPackage(Package packageToEdit, ManagePackagesListing managePackagesListing = null)
        {
            InitializeComponent();
        ...
        //when added PopulateFields() in AddEditPackage() above, double click, this section will show
        private void PopulateFields(Package packageToEdit)
        {
